...
/**
 * Servlet implementation class ReimbursementRequestsPage
 */
public class SubmittedRequestsPage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubmittedRequestsPage() {
        super();
