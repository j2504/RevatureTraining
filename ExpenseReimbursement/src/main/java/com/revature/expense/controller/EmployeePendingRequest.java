...
/**
 * Servlet implementation class EmployeePendingRequest
 */
public class EmployeePendingRequest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeePendingRequest() {
        super();
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		r = erDI.getPendingSubmittedRequests(userN);
		...
		out.print("</table></br>");
		out.print("<button onclick=\"window.location.href='EPR'\">Show Pending Requests</button> <button onclick=\"window.location.href='ELog'\">Show All Requests</button>");
