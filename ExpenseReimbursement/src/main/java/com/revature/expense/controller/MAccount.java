...
/**
 * Servlet implementation class MAccount
 */
public class MAccount extends HttpServlet {
	...
	protected void printAccountInfo(HttpServletRequest request, HttpServletResponse response)
		...
		if(userN != null) {
			...
			out.print("<form action='MLogOut.html' method='post'><fieldSet><h3 style='text-align:center'>Account Info</h3>");
			for (Users u : userInfo) {
				...
				out.print("<button type=\"button\" onclick=\"window.location.href='MUpdateAcct.html'\">Update</button>  <button type=\"button\" onclick=\"window.location.href='MDeleteAcct.html'\">Delete</button>");
	...
	protected void pageHeader(HttpServletResponse resp) throws IOException{
		...
		out.print("<div class=\"header\">\r\n" + "        <a href=\"MA\" class=\"logo\">Revature</a>\r\n"
